...
export function ExperienceEditor({
  ...
  const unitsConfig = useMemo(
    () => ({
      ...
      unitBlocksSelectedOutlineWidth: configEditor.draft.unitBlocksSelectedOutlineWidth,
      unitBlocksSelectedScaleEnabled: configEditor.draft.unitBlocksSelectedScaleEnabled,
      unitBlocksSelectedScale: configEditor.draft.unitBlocksSelectedScale,
      unitBlocksSelectedFillEnabled: configEditor.draft.unitBlocksSelectedFillEnabled,
      unitColorSelectedFill: configEditor.draft.unitColorSelectedFill,
      unitBlocksSelectedXrayEnabled: configEditor.draft.unitBlocksSelectedXrayEnabled,
  ...
  const environmentConfig = useMemo(
    () => ({
      ...
      backdropElevation: configEditor.draft.backdropElevation,
  ...
  const renderingConfig = useMemo(
    () => ({
      ...
      distanceBlurEnabled: configEditor.draft.distanceBlurEnabled,
      distanceBlurStartM: configEditor.draft.distanceBlurStartM,
      distanceBlurFullM: configEditor.draft.distanceBlurFullM,
      distanceBlurAmount: configEditor.draft.distanceBlurAmount,
      distanceBlurRadius: configEditor.draft.distanceBlurRadius,
