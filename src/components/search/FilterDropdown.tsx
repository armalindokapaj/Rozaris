  ...
  return (
    <div className={cn("relative", className)} ref={ref}>
      <button
        ...
        aria-expanded={open}
        className={cn(
          "flex h-12 w-full items-center justify-between gap-2 whitespace-nowrap rounded-none border border-neutral-300 bg-white px-4 text-base font-semibold transition-colors",
          active || open
      ...
      {open && (
        <div
          className={cn(
            "absolute top-[calc(100%+2px)] z-40 w-80 max-w-[calc(100vw-2rem)] rounded-none border border-neutral-300 bg-white p-5 shadow-[0_3px_9px_rgba(17,24,39,0.24)]",
