...
export function OnboardingHint() {
  ...
  return (
    <div
      role="status"
      className="glass-panel pointer-events-auto absolute left-1/2 top-4 z-20 flex w-[min(92vw,380px)] -translate-x-1/2 items-start gap-3 rounded-panel px-4 py-3.5 lg:top-24"
    >
